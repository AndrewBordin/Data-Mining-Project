...
'''
#------------------------------------------------------------#
# WRITING ALL THE HELPER FUNCTIONS FOR APRIORI IMPLEMENTATION
#------------------------------------------------------------#
# create_Combinations returns combination_size length subsequences of elements from the input iterable.
...
def join_set_itemsets(set_of_its, order):
    ...
    for i in range(len(set_of_its)):
        for j in range(i + 1, len(set_of_its)):
            # need join_two_itemsets that will join two itemsets that are in positon i and j
...
if database == 1:
    path_to_data = "ShopRite.txt"
elif database == 2:
    path_to_data = "Walmart.txt"
elif database == 3:
    path_to_data = "BestBuy.txt"
elif database == 4:
    path_to_data = "Amazon.txt"
elif database == 5:
    path_to_data = "IKEA.txt"
else:
    print('Error')
...
print('-----------------------------')
print('Starting Apriori Approach')
print('-----------------------------')
...
print('Time taken with Apriori Approach',round(end_apriori - start_apriori,4))
...
'''
#------------------------------------------------------------#
# WRITING ALL THE HELPER FUNCTIONS FOR BruteForce IMPLEMENTATION
#------------------------------------------------------------#
